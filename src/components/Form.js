...
//handles form input changes
  ...
  //handles switching to free form type
...
//form submission
  function handleSubmit(e) {
    ...
    //check request tyoe before making an API call
    ...
    if (reqType === "add") {
      axios.post(apiUrl, formInput )
        ...
        axios.patch(apiUrl + formInput.id, formInput)
            .then(res => {
                toggleModal();
                getData()
            })
          ...
          <div>
            ...
            <div className="mb-4">
              ...
              <button type="submit" className="
                ...
                bg-blue-600
                rounded-lg
                hover:bg-blue-700"> Save Address </button>
                </div>
